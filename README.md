...
The Docker on the first run will download the same version as tagged `All the Mods 10-4.14` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs, and it will eventually finish.
...
* MOTD "All the Mods 10-4.14 Server Powered by Docker"
